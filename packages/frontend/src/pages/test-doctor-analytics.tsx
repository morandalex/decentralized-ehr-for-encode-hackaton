    ...
    function getDecodedGrantAccess(d) {
        ...
        d && d.data.items.map(
            (item) => {
                ...
                console.log("For grant access", eventData[index].eventTopicNameEncoded)
                ...
                && (
                            <TableContainer>
                                <Table variant='striped' colorScheme='teal'>
                                    <TableCaption placement='top'>Patient Document Timelines</TableCaption>
                                    <Thead>
                                        <Tr>
                                        ...
                                        <Divider my='1'></Divider>
                                            <TableContainer>                                          
                                                <Table variant='striped' colorScheme='teal'>
                                                    <Tbody>
                                                    <Tr>
                                                        <Td overflowX='auto'>{item.patientAddress}</Td>
                                                        <Td overflowX='auto'>{item.documentTypes}</Td>
                                                        <Td isNumeric>{item.start}</Td>
                                                        <Td isNumeric>{item.end}</Td>
                                                    </Tr>
                                                    </Tbody>
                                                </Table> 
                                          </TableContainer>
